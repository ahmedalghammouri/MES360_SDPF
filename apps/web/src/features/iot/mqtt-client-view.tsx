...
/** Split `mes360/<factory>/<seg>/<leaf>` into a readable leaf + muted parent path. */
        ...
        <div className="flex flex-col overflow-hidden">
          ...
          <div className="border-t border-border/40 p-3 flex items-end gap-2">
            <div className="flex-1 grid grid-cols-[1fr_2fr] gap-2">
              <Input placeholder="Topic (mes360/…)" value={pubTopic} onChange={(e) => setPubTopic(e.target.value)} className="h-8 text-xs font-mono" />
