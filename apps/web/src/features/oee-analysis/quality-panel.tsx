...
import { Gauge, pctText, STATUS } from './chart-kit';
        ...
        <section className="rounded-lg border border-border/60 bg-card p-4">
          ...
          {trend.length === 0 ? (
            ...
            <div className="h-[180px] w-full">
              <ResponsiveContainer>
                <LineChart data={trend.map((p) => ({ t: hhmm(p.at), quality: p.quality }))}
                  ...
                  <Line type="monotone" dataKey="quality" stroke="var(--viz-1)" strokeWidth={2}
