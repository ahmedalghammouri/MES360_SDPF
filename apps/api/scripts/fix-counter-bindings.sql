...
-- M1 Big Betti — both counters sat on DI0, so the filler could never report a
...
-- M3 Cartomac — TOTAL and GOOD were swapped against the module's own numbering
...
-- counter on the plant module at all (NCC's mapping gives it a run-mode bit and
