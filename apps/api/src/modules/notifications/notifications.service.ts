...
export class NotificationsService {
  ...
  async sendEmail(dto: SendNotificationDto): Promise<void> {
    ...
    await this.mailer.sendMail({
      from: this.config.get<string>('smtp.from', 'MES360° <noreply@mes360.sa>'),
      to: user.email,
      subject: dto.title,
    ...
    return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background: #1a1f2e; padding: 20px; border-radius: 8px 8px 0 0;">
          <h1 style="color: #6175f4; margin: 0; font-size: 18px;">MES360°</h1>
        ...
        <div style="background: #f5f7ff; padding: 30px; border-radius: 0 0 8px 8px;">
          ...
          <p style="color: #888; font-size: 12px; margin: 0;">
            This is an automated notification from MES360° Platform.<br>
