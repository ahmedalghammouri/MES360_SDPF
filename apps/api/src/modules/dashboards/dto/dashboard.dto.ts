...
export class CreateDashboardDto {
  ...
  @ApiPropertyOptional({ description: 'Internal route for MES360_NATIVE / REPORT' })
  @ValidateIf(o => o.source === DashboardSource.MES360_NATIVE || o.source === DashboardSource.REPORT)
