export const configuration = () => ({
  ...
  influx: {
    ...
    org: process.env.INFLUX_ORG || 'mes360',
  ...
  smtp: {
    ...
    from: process.env.EMAIL_FROM || 'MES360° <noreply@mes360.sa>',
  },
  ...
  mqtt: {
    ...
    clientId: process.env.MQTT_CLIENT_ID || 'mes360',
  },
  ...
  storage: {
    ...
    minio: {
      ...
      bucket: process.env.MINIO_BUCKET || 'mes360',
    },
  },
