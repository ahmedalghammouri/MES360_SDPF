...
async function bootstrap() {
  ...
  appLogger.log(`CORS allow-list: ${corsOrigins.join(', ')} (+ LAN ranges & *.mes360/*.industry360 .com/.sa)`);
  app.enableCors({
  ...
  appLogger.log(`🚀 MES360° API running on port ${port}`);
