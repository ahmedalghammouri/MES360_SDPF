 ...
 *   - the whole mes360 / industry360 domain family (any subdomain, http/https,
 *     any port) so platform/poc/app.mes360.com (.sa) and mes360.industry360.sa
...
export const PUBLIC_ORIGIN =
  /^https?:\/\/([a-z0-9-]+\.)*(mes360|industry360)\.(com|sa)(:\d+)?$/i;
