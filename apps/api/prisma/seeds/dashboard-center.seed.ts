...
const NATIVE: DashboardSeed[] = [
  ...
  { slug: 'manufacturing-oee', title: 'OEE Breakdown', description: 'The same window cut by machine, job order and shift, with the KPI sheet beside it — which asset, which order or which crew is holding the line back.', source: DashboardSource.MES360_NATIVE, type: DashboardType.ANALYTICS, categoryKey: 'production', icon: 'Table2', route: '/oee-breakdown', tags: ['oee', 'breakdown', 'machines', 'shifts', 'job-orders'], supportedScopes: ['FACTORY', 'AREA', 'LINE', 'MACHINE'] },
