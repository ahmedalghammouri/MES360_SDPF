...
-- The seeded data had RNTIC in Jeddah and NDPF in Dammam. These links put them
...
-- NDPF's own name, so the original pair looks transposed and these links
...
SELECT * FROM (VALUES
  ...
  ('SIDCO', 26.2539087, 49.9876848, 'Dammam', '2nd Industrial City, Dammam 34326, Eastern Province',
            'Saudi Industrial Detergents Company'),
  ('SAF',   25.9265816, 49.9448726, 'Dammam', '3rd Industrial City, Dammam, Eastern Province',
            'SIDCO Aerosol Factory'),
  ('RNTIC', 26.2524912, 49.9857344, 'Dammam', '2nd Industrial City, Dammam 34326, Eastern Province',
            'EIDA3448, Dammam 34326 - moved from Jeddah, please confirm'),
  ('NDPF',  21.4112773, 39.2425602, 'Jeddah', 'Jeddah, Makkah Province',
