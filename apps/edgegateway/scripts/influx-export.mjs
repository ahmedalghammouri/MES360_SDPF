...
//   INFLUX_URL=http://mes360.industry360.sa:8086 INFLUX_TOKEN=xxx node scripts/influx-export.mjs
...
const ORG = arg('org', process.env.INFLUX_ORG || cfg.org || env.org || 'mes360');
const BUCKET = arg('bucket', process.env.INFLUX_BUCKET || cfg.bucket || env.bucket || 'mes_timeseries');
